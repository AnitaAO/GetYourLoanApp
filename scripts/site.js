...
function generateRickProfile(la) {
    ...
    let dr = nameAndTitle.startWidth("dr");
    let phd = nameAndTitle.startWidth("phd");
    let phd2 = nameAndTitle.startWidth("ph.d");

    let md = nameAndTitle.endWidth("md");
    let md2 = nameAndTitle.endWidth("m.d");
    let md3 = nameAndTitle.endWidth("m.d.");
